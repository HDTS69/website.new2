...
export function Hero() {
  ...
  React.useEffect(() => {
    // Use requestAnimationFrame to ensure the component is mounted after the browser has painted
  ...
  return (
    <div className="relative min-h-[100dvh] flex flex-col bg-black opacity-[0.99] animate-fade-in animation-delay-200 overflow-x-hidden overflow-y-auto pb-24 pt-16">
      {/* Sparkles Animation */}
          ...
          <LazyAnimatePresence mode="wait">
            {isLoaded && (
              <LazyMotionDiv 
                ...
                initial={{ y: '20vh', opacity: 0.01 }} // Use 0.01 instead of 0 to avoid Lighthouse LCP detection issues
                animate={{ 
                  y: 0,
                  opacity: 1,
                  transition: {
                    ...
                    mass: 0.75,
                    stiffness: 100,
                    delay: 0.1 // Reduced delay for faster appearance
                  }
                }}
                key="hero-image"
              >
        ...
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto select-none transform-gpu mt-6 mb-20">
          ...
          <div className="flex flex-col items-center mt-2 space-y-4">
            <h1 className="flex flex-col gap-1 text-[2rem] leading-[1.15] font-bold text-white tracking-tight">
              <span className="opacity-[0.99] animate-fade-in-up animation-delay-300">Brisbane</span>
              <span className="opacity-[0.99] animate-fade-in-up animation-delay-400 bg-gradient-to-r from-[#00E6CA] to-[#00E6CA]/80 bg-clip-text text-transparent">24/7 Emergency</span>
              <span className="opacity-[0.99] animate-fade-in-up animation-delay-500">Repairs &amp; Installations</span>
            </h1>
            
            <p className="text-base leading-relaxed opacity-[0.99] animate-fade-in-up animation-delay-600 font-medium bg-black/40 backdrop-blur-sm px-4 py-3 rounded-2xl max-w-[280px] mx-auto">
            ...
            <div className="opacity-[0.99] animate-fade-in-up animation-delay-700 bg-black/40 backdrop-blur-sm px-4 py-3 rounded-2xl max-w-[280px] mx-auto">
            ...
            <div className="opacity-[0.99] animate-fade-in-up animation-delay-800 bg-black/40 backdrop-blur-sm px-4 py-3 rounded-2xl max-w-[280px] mx-auto">
            ...
            <div className="opacity-[0.99] animate-scale-up animation-delay-900 transform-gpu mt-4">
              <AnimatedButton 
                href="#book"
                variant="primary"
